...
export const homeBlocks = [
  {
    ...
    content:
      "Попали в аварию на трассе Р-176 «Вятка»? Заглохли в центре Сыктывкара, в Эже, на Дырносе или нужна перевозка автомобиля из Ухты в Печору?\n\nСлужба эвакуации «Эва Коми» оперативно приедет на помощь в любой точке Республики Коми. Мы работаем круглосуточно, без выходных и праздников.\n\nНаш автопарк укомплектован современными эвакуаторами для легковых и грузовых автомобилей, внедорожников, микроавтобусов и мототехники.",
  },
  {
    __typename: "ComponentEvaKomiText",
